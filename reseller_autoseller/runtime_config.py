...
SETTING_DEFINITIONS = [
    ...
    SettingDefinition(
        ...
        "Digiseller notification secret",
        sensitive=True,
        label_ru="Секрет URL-уведомлений Digiseller",
        description="Secret part of the Digiseller sale/message notification URLs.",
    ...
    SettingDefinition(
        ...
        kind="boolean",
        label_ru="URL-уведомления Digiseller о продажах",
        description="Accept incoming sale notifications from Digiseller and ask the buyer for the unique code without polling.",
        description_ru="Принимать уведомления Digiseller о продажах и запрашивать уникальный код без постоянного polling.",
    ),
    SettingDefinition(
        "digiseller_message_notifications_enabled",
        "Digiseller message notifications",
        kind="boolean",
        label_ru="URL-уведомления Digiseller о сообщениях",
        description="Accept incoming buyer message notifications from Digiseller.",
        description_ru="Принимать уведомления Digiseller о новых сообщениях покупателей.",
    ),
    SettingDefinition(
        "digiseller_validate_sale_sha256",
    ...
    SettingDefinition(
        ...
        "Digiseller polling fallback",
        kind="boolean",
        label_ru="Fallback polling Digiseller",
        description="Periodically check unread Digiseller chats as an emergency fallback. Disabled by default because Digiseller limits read requests.",
        description_ru="Периодически проверять непрочитанные чаты Digiseller как аварийный запасной вариант. По умолчанию выключено из-за лимита read-запросов Digiseller.",
    ),
