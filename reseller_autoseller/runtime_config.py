...
SETTING_DEFINITIONS = [
    ...
    SettingDefinition(
        ...
        description="Keep slow polling as a backup when URL notifications are not configured or missed.",
        description_ru="Оставить медленный polling как запасной вариант, если URL-уведомления не настроены или не дошли.",
    ),
