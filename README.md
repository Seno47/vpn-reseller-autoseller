...
Если выбираете установку с доменом и HTTPS, дополнительно нужны `nginx`, `certbot` и `python3-certbot-nginx`. Linux-установщик ставит эти пакеты сам.
